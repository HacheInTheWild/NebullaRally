...
public class CameraController : MonoBehaviour
{
    ...
    { 
        ...
        lookrotation.eulerAngles = new Vector3(inclinacion, 180f, 0f); //inclinaci¨®n de la camara (diagonal hacia abajo para mirarla, mirar desde detras de la nave, inclinaci¨®n lateral)
